...
export default function GasQuestion() {
        ...
        <div className="question-screen__content">
          ...
          <div className="question-screen__hero">
            <h1 className="question-screen__title">
              Do you get gas, acidity or bloating?
            </h1>
          ...
          <ul className="gender-options" aria-label="Acidity options" style={{ display: "flex", flexDirection: "column", gap: "1.5rem", maxWidth: "45rem", margin: "0 auto 3rem" }}>
            {options.map((option) => {
