      ...
      <div className="container question-shell">
        ...
        <div className="question-screen__content">
          <QuestionProgress
            ...
            progress={56}
            questionLabel="Question 9 of 15"
          />
          ...
          <ul className="gender-options" aria-label="Sleep options" style={{ display: "flex", flexDirection: "column", gap: "1.5rem", maxWidth: "45rem", margin: "0 auto 3rem" }}>
            {options.map((option) => {
