    ...
    <section className="screen-gradient-bg question-screen">
      <div className="container question-shell">
        ...
        <div className="question-screen__content">
          ...
          <ul className="gender-options" aria-label="Scalp flaking options" style={{ display: "flex", flexWrap: "wrap", justifyContent: "center", gap: "3rem", margin: "4.8rem auto 0", maxWidth: "100rem" }}>
            {options.map((option) => {
