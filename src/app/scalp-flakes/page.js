      ...
      <div className="container question-shell">
        ...
        <div className="question-screen__content">
          <QuestionProgress
            ...
            progress={50}
            questionLabel="Question 8 of 15"
          />
          ...
          <ul className="gender-options" aria-label="Scalp flaking options" style={{ display: "flex", flexDirection: "column", gap: "1.5rem", maxWidth: "45rem", margin: "0 auto 3rem" }}>
            {options.map((option) => {
