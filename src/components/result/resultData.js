...
import doctorImage from "@/images/dr-neha-profile.webp";
...
export const resultTestimonials = [
  {
    id: "video-1",
    youtubeId: "3qe46DUEG2A",
    name: "Sushant Gupta",
    review: "I had my transplant at QHT and used to collect my medicines from the clinic. Now I just order them on URoots and they get delivered to my door.",
  },
  {
    id: "video-2",
    youtubeId: "eSGLhqPBez8",
    name: "Sounu Kumar",
    review: "Six months after my transplant, I'm still following my QHT medicines. My results speak for themselves, and now I get everything on URoots.",
  },
  {
    id: "video-3",
    youtubeId: "yP_Cq6l4pFY",
    name: "Shivam Tyagi",
    review: "I had my transplant in September 2025 and have followed my medicines ever since. Five months in, no side effects, and my PRP sessions have really cut down my hair fall.",
  },
  {
    id: "video-4",
    youtubeId: "7VVr76Z6j20",
    name: "Shahid",
    review: "It's been ten months since my transplant, and I've always got my medicines from the clinic. Now I just order them on URoots and they reach my home anywhere in India.",
  },
  {
    id: "video-5",
    youtubeId: "qqGeqnYC-FQ",
    name: "Saeem Khan",
    review: "When I had some itching after my transplant, my doctor suggested the URoots scalp oil. Using it made my scalp feel much more comfortable.",
  },
  {
    id: "video-6",
    youtubeId: "iheOSqAliJM",
    name: "Nitin",
    review: "I'm three months post-transplant and back for my second PRP session. I've stayed consistent with everything my doctor gave me, and it's been an easy, comfortable process.",
  },
  {
    id: "video-7",
    youtubeId: "uYqwAscnedQ",
    name: "Jahid Ahmed",
    review: "It's been over a year since my transplant and I've kept up my medicines throughout. I order everything from URoots, and the personal kit has worked really well for me.",
  },
  {
    id: "video-8",
    youtubeId: "_1yySV94Zjc",
    name: "Ashutosh Kumar",
    review: "I regularly take the multivitamin, serum and other medicines my doctors prescribed. I'm here for my second PRP, and the growth and density look great.",
  },
  {
    id: "video-9",
    youtubeId: "lYgyxOEbc7U",
    name: "Abhinav Jaiswal",
    review: "I had my transplant at QHT, so why get my medicines from a local shop? I order the same post-care products on URoots and they're delivered straight to my home.",
  },
];
